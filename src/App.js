...
const apiKey ="437d0c40d232c814a0a3f31c6d5cea57";
  ...
  return (
    <div className='bg-gray-800 h-screen grid place-items-center'>
      <div className='bg-white w-96 p-4 rounded-md'>
        ...
        <input type="text" ref={inputRef} placeholder="Enter your Location" 
       ...
       <button onClick={fetchWeather}>
        ...
        <div className={`duration-300 delay-75 overflow-hidden ${showWeather ? 'h-[27rem]': 'h-0' }`}>
          ...
          <img
            ...
            <img src={showWeather[0]?.img} 
            alt="..." className='w-52 mx-auto'
             />
